...
/** PHPWord_Style_Cell */
require_once PHPWORD_BASE_PATH . 'PHPWord/Style/Cell.php';

/** PHPWord_Section_Footer_PreserveText */
require_once PHPWORD_BASE_PATH . 'PHPWord/Section/Footer/PreserveText.php';
...
class PHPWord_Section_Table_Cell {
	 ...
	 */
	public function addPreserveText($text, $style = null) {
		if($this->_insideOf == 'footer' || $this->_insideOf == 'header') {
			$text = utf8_encode($text);
			$ptext = new PHPWord_Section_Footer_PreserveText($text, $style);
