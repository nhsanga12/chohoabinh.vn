...
require_once PHPWORD_BASE_PATH . 'PHPWord/Writer/Word2007/Base.php';
require_once PHPWORD_BASE_PATH . 'PHPWord/Shared/XMLWriter.php';
require_once PHPWORD_BASE_PATH . 'PHPWord/Shared/String.php';
require_once PHPWORD_BASE_PATH . 'PHPWord/Shared/Font.php';
...
class PHPWord_Writer_Word2007_Document extends PHPWord_Writer_Word2007_Base {
	...
	private function _writeListItem(PHPWord_Shared_XMLWriter $objWriter = null, PHPWord_Section_ListItem $listItem) {
		...
		$objWriter->startElement('w:p');
			...
			$this->_writeText($objWriter, $textrun, true);
