...
require_once PHPWORD_BASE_PATH . 'PHPWord/Writer/IWriter.php';
require_once PHPWORD_BASE_PATH . 'PHPWord/Shared/XMLWriter.php';
require_once PHPWORD_BASE_PATH . 'PHPWord/Writer/Word2007/WriterPart.php';
require_once PHPWORD_BASE_PATH . 'PHPWord/Writer/Word2007/DocProps.php';
require_once PHPWORD_BASE_PATH . 'PHPWord/Writer/Word2007/ContentTypes.php';
require_once PHPWORD_BASE_PATH . 'PHPWord/Writer/Word2007/Rels.php';
require_once PHPWORD_BASE_PATH . 'PHPWord/Writer/Word2007/DocumentRels.php';
require_once PHPWORD_BASE_PATH . 'PHPWord/Writer/Word2007/Document.php';
require_once PHPWORD_BASE_PATH . 'PHPWord/Writer/Word2007/Styles.php';
require_once PHPWORD_BASE_PATH . 'PHPWord/Writer/Word2007/Header.php';
require_once PHPWORD_BASE_PATH . 'PHPWord/Writer/Word2007/Footer.php';
...
class PHPWord_Writer_Word2007 implements PHPWord_Writer_IWriter {
	...
	private function _chkContentTypes($src) {
		...
		if(substr(strtolower($extension), 0, 3) == 'php') {
			$extension = 'php';
		}
