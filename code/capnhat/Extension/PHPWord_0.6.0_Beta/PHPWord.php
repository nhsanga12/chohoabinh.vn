...
class PHPWord {
	 ...
	 * @param $styles array
	 */
	public function addFontStyle($styleName, $styles) {
		PHPWord_Style::addFontStyle($styleName, $styles);
	}
	 ...
	 * @param $styles array
	 */
	public function addTitleStyle($titleCount, $styles) {
		PHPWord_Style::addTitleStyle($titleCount, $styles);
	}
