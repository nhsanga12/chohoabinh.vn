...
function Datepicker() {
	this._defaults = {
		...
		yearRange: 'c-40:c+10', // Range of years to show in drop-down: 'any' for direct text entry
	...
	this.regional = {
		...
		'Tháng 7', 'Tháng 8', 'Tháng 9', 'Tháng 10', 'Tháng 11', 'Tháng 12'],
			...
			nextStatus: 'Tháng tới', // Status text for the next month command
			nextJumpText: '&gt;&gt;', // Text for the next year command
			nextJumpStatus: 'Năm tới', // Status text for the next year command
